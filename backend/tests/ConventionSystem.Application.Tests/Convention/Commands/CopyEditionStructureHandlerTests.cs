...
public class CopyEditionStructureHandlerTests
{
    ...
    {
        _handler = new CopyEditionStructureHandler(_editionRepo, _conventionRepo, _currentUser);
    }
    ...
    public async Task Handle_ValidCommand_CopiesStructure()
    {
        ...
        await _handler.Handle(new CopyEditionStructureCommand(target.Id.Value, source.Id.Value), default);
    ...
    public async Task Handle_TargetNotFound_Throws()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(
            () => _handler.Handle(new CopyEditionStructureCommand(Guid.NewGuid(), Guid.NewGuid()), default));
    }
    ...
    public async Task Handle_PerformerNotAdministrator_Throws()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(
            () => _handler.Handle(new CopyEditionStructureCommand(target.Id.Value, source.Id.Value), default));
    }
    ...
    public async Task Handle_SourceFromDifferentConvention_Throws()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(
            () => _handler.Handle(new CopyEditionStructureCommand(target.Id.Value, otherSource.Id.Value), default));
    }
    ...
    public async Task Handle_TargetIsPublished_Throws()
    {
        ...
        await Assert.ThrowsAsync<EditionMustBeDraftToCopyStructureException>(
            () => _handler.Handle(new CopyEditionStructureCommand(target.Id.Value, source.Id.Value), default));
    }
}
