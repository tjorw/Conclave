...
public class ApproveVersionHandlerTests
{
    ...
    [Fact]
    public async Task Handle_CategoryResponsible_PublishedVersionIdIsSet()
    {
        var (_, responsible, _, ev) = Setup();
    ...
    [Fact]
    public async Task Handle_CategoryResponsible_RaisesVersionApprovedEvent()
    {
        var (_, responsible, _, ev) = Setup();
    ...
    [Fact]
    public async Task Handle_NotUnderReview_Throws()
    {
        var (_, responsible, _, ev) = Setup();
