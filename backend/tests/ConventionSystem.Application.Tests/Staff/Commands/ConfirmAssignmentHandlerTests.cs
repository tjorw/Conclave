...
public class ConfirmAssignmentHandlerTests
{
    ...
    {
        _handler = new ConfirmAssignmentHandler(_shiftRepo, _editionRepo, _conventionRepo, _currentUser);
    }
    ...
    public async Task Handle_ShiftNotFound_Throws()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(
            () => _handler.Handle(new ConfirmAssignmentCommand(Guid.NewGuid(), Guid.NewGuid()), default));
    }
