...
public class EditionCopyStructureTests
{
    ...
    public void CopyStructure_CopiesAllVenues()
    {
        ...
        target.CopyStructure(source.Id, source.Venues, source.Stations, PersonId.New());
    ...
    public void CopyStructure_CopiesAllStations()
    {
        ...
        Assert.Equal("Reception", target.Stations[0].Name);
    }
    ...
    [Fact]
    public void CopyStructure_OverwritesExistingVenues()
    {
        var (_, source, target) = CreateSetup();
