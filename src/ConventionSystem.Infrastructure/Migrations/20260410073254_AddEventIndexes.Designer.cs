...
namespace ConventionSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260410073254_AddEventIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConventionSystem.Domain.Event.Entities.EventVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("EventId")
                        .HasDatabaseName("IX_event_versions_event_id");

                    b.ToTable("event_versions", (string)null);
                });
            ...
            modelBuilder.Entity("ConventionSystem.Domain.Event.Entities.SessionRequest", b =>
                {
                    ...
                    b.HasIndex("EventVersionId")
                        .HasDatabaseName("IX_session_requests_event_version_id");
            ...
            modelBuilder.Entity("ConventionSystem.Domain.Event.Aggregates.Event", b =>
                {
                    b.HasOne("ConventionSystem.Domain.Event.Entities.EventVersion", null)
                        .WithMany()
